...
#[test]
fn sum_of_multiple_implementations_agree() {
    assert_eq!(sum_of_multiple(100, 3), sum_of_multiple_brute(100, 3))
}
...
#[test]
fn prime_factorization_of_48() {
    assert_eq!(prime_factorization(48), vec![2, 2, 2, 2, 3])
}
